...
sr = 2;     % s/r = metti NaN nel caso SR/IR, sennò cambia sr sotto 
...
% cases.filename = [
%     "APC_20x13_SR_RPM1000.csv"
%     "APC_20x13_SR_RPM1500.csv"
%     "APC_20x13_SR_RPM2000.csv"
%     "APC_20x13_SR_RPM2500.csv"
%     "APC_20x13_SR_RPM3000.csv"
%     "APC_20x13_SR_RPM3500.csv"
%     "APC_20x13_SR_RPM4000.csv"
%     "APC_20x13_SR_RPM4500.csv"
% ];

cases.filename = [
    "APC_20x13_DR_RPM1000.csv"
    "APC_20x13_DR_RPM1500.csv"
    "APC_20x13_DR_RPM2000.csv"
    "APC_20x13_DR_RPM2500.csv"
    "APC_20x13_DR_RPM3000.csv"
    "APC_20x13_DR_RPM3500.csv"
    "APC_20x13_DR_RPM4000.csv"
    "APC_20x13_DR_RPM4500.csv"
];
...
for ic = 1:height(cases)
    ...
    if computeRotor1
        ...
        R1 = rotorStatsSingleRamp( ...
                t, data, idx, col.T1, col.Q1, col.rpm1, col.V1, col.A1, col.pwm1, ...
    ...
    if computeRotor2
       ...
       R2 = rotorStatsSingleRamp( ...
                t, data, idx, col.T2, col.Q2, col.rpm2, col.V2, col.A2, col.pwm2, ...
...
function R = rotorStatsSingleRamp(t, data, idx, colT, colQ, colRPM, colV, colA, colPWM, ...
